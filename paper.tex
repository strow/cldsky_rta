%[sergio@tara-fe1 PAPER11_GIT_CLDSKY_RTA]$ git remote -v
%github		 git@github.com:strow/cldsky_rta.git (fetch)
%github		 git@github.com:strow/cldsky_rta.git (push)
%origin		 https://github.com/strow/cldsky_rta.git (fetch)
%origin		 https://github.com/strow/cldsky_rta.git (push)
%[sergio@tara-fe1 PAPER11_GIT_CLDSKY_RTA]$ git push github master
