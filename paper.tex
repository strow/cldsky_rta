...
{\small
\hfill{}
\begin{tabular}{cccccccccccc} % centered columns (4 columns)
...
\label{table:SvsP} % is used to refer this table in the text
\end{table*}
\end{center}
...
\label{table:georegions_ocean} % is used to refer this table in the text
\end{table*}
\end{center}
...
\label{table:georegions_land} % is used to refer this table in the text
\end{table*}
\end{center}
...
\label{table:night_clear2} % is used to refer this table in the text
\end{table*}
\end{center}
